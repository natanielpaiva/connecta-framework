 ...
 *         &lt;element name="filterRuleKey" type="{http://www.endeca.com/endeca-server/sconfig/3/0}filterRuleKey" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "deleteFilterRules")
public class DeleteFilterRules {

    protected String outerTransactionId;
    @XmlElement(defaultValue = "en")
    protected String language;
    protected List<FilterRuleKey> filterRuleKey;
    ...
    /**
     * Gets the value of the filterRuleKey property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the filterRuleKey property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFilterRuleKey().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FilterRuleKey> getFilterRuleKey() {
        if (filterRuleKey == null) {
            filterRuleKey = new ArrayList<FilterRuleKey>();
        }
        return this.filterRuleKey;
    }
