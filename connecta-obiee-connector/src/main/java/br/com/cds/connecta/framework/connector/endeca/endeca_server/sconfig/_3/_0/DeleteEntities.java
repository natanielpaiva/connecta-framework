 ...
 *         &lt;element name="semanticEntityKey" type="{http://www.endeca.com/endeca-server/sconfig/3/0}semanticEntityKey" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeleteEntities {
    ...
    /**
     * Gets the value of the semanticEntityKey property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the semanticEntityKey property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSemanticEntityKey().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SemanticEntityKey }
     * 
     * 
     */
    public List<SemanticEntityKey> getSemanticEntityKey() {
        if (semanticEntityKey == null) {
            semanticEntityKey = new ArrayList<SemanticEntityKey>();
        }
        return this.semanticEntityKey;
    }
