 ...
 *         &lt;element name="collectionUpdate" type="{http://www.endeca.com/endeca-server/sconfig/3/0}collectionUpdate" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UpdateCollections {
    ...
    /**
     * Gets the value of the collectionUpdate property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the collectionUpdate property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCollectionUpdate().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CollectionUpdate> getCollectionUpdate() {
        if (collectionUpdate == null) {
            collectionUpdate = new ArrayList<CollectionUpdate>();
        }
