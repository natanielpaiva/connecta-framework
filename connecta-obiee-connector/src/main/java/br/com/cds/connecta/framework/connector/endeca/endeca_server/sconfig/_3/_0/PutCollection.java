 ...
 *         &lt;element name="collection" type="{http://www.endeca.com/endeca-server/sconfig/3/0}collection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "putCollection")
public class PutCollection {
    ...
    /**
     * Obt\u00e9m o valor da propriedade collection.
     * 
     * @return
     *     possible object is
     *     {@link Collection }
    ...
    /**
     * Define o valor da propriedade collection.
     * 
     * @param value
     *     allowed object is
     *     {@link Collection }
