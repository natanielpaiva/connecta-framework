 ...
 *         &lt;element name="filterRule" type="{http://www.endeca.com/endeca-server/sconfig/3/0}filterRule"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "putFilterRule")
public class PutFilterRule {
    ...
    /**
     * Obt\u00e9m o valor da propriedade filterRule.
     * 
     * @return
     *     possible object is
     *     {@link FilterRule }
    ...
    /**
     * Define o valor da propriedade filterRule.
     * 
     * @param value
     *     allowed object is
     *     {@link FilterRule }
     *     
     */
    public void setFilterRule(FilterRule value) {
