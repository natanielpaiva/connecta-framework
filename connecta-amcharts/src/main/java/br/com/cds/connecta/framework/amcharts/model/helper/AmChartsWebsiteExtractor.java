package br.com.cds.connecta.framework.amcharts.model.helper;
...
public class AmChartsWebsiteExtractor {
    ...
    public String extractSuperClass(String text) {
    ...
    private void writeClassFile(File outputFile) throws IOException {
        ...
        FileUtils.write(outputFile, "package br.com.cds.connecta.framework.amcharts;\n\n");
