...
public class AmGraph implements Serializable {
    ...
    /**
     * Balloon text. You can use tags like [[value]], [[description]],
     * [[percents]], [[open]], [[category]] or any other field name from your
     * data provider. HTML tags can also be used.
     *
     */
    ...
    /**
     * Type of the bullets. Possible values are: "none", "round", "square",
     * "triangleUp", "triangleDown", "triangleLeft", "triangleRight", "bubble",
     * "diamond", "xError", "yError" and "custom".
     *
     */
    ...
    /**
     * bulletAxis value is used when you are building error chart. Error chart
     * is a regular serial or XY chart with bullet type set to "xError" or
     * "yError". The graph should know which axis should be used to determine
     * the size of this bullet - that's when bulletAxis should be set. Besides
     * that, you should also set graph.errorField. You can also use other bullet
     * types with this feature too. For example, if you set bulletAxis for XY
     * chart, the size of a bullet will change as you zoom the chart.
     *
     */
    ...
    /**
     * Bullet offset. Distance from the actual data point to the bullet. Can be
     * used to place custom bullets above the columns.
     *
     */
    ...
    /**
     * Name of the close field (used by candlesticks and ohlc) in your
     * dataProvider.
     *
     */
    ...
    /**
     * In case you want to place this graph's columns in front of other columns,
     * set this to false. In case "true", the columns will be clustered next to
     * each other.
     *
     */
    ...
    /**
     * You can specify custom column width for each graph individually. Value
     * range is 0 - 1 (we set relative width, not pixel width here).
     *
     */
    ...
    /**
     * Specifies whether to connect data points if data is missing. The default
     * value is true.
     *
     */
     ...
     * chart's depth and angle styles must be set to 0. The default value is 0.
     * Note, cornerRadiusTop will be applied for all corners of the column,
     * JavaScript charts do not have a possibility to set separate corner radius
     * for top and bottom. As we want all the property names to be the same both
     * on JS and Flex, we didn't change this too.
     *
     */
    ...
    /**
     * If bulletsEnabled of ChartCurosor is true, a bullet on each graph follows
     * the cursor. You can set opacity of each graphs bullet. In case you want
     * to disable these bullets for a certain graph, set opacity to 0.
     *
     */
    ...
    /**
     * Dash length. If you set it to a value greater than 0, the graph line (or
     * columns border) will be dashed.
     *
     */
    ...
    /**
     * Name of the dash length field in your dataProvider. This property adds a
     * possibility to change graphs’ line from solid to dashed on any data
     * point. You can also make columns border dashed using this setting.
     *
     */
    ...
    /**
     * Opacity of fill. Plural form is used to keep the same property names as
     * our Flex charts'. Flex charts can accept array of numbers to generate
     * gradients. Although you can set array here, only first value of this
     * array will be used.
     *
     */
    ...
    /**
     *      *Fill color. Will use lineColor if not set. You can also set array of
     * colors here.
     *
     */
    ...
    /**
     * Name of the fill colors field in your dataProvider. This property adds a
     * possibility to change line graphs’ fill color on any data point to create
    ...
    /**
     * You can set another graph here and if fillAlpha is >0, the area from this
     * graph to fillToGraph will be filled (instead of filling the area to the X
     * axis).
     *
     */
    ...
    /**
     * Specifies whether the graph is hidden. Do not use this to show/hide the
     * graph, use hideGraph(graph) and showGraph(graph) methods instead.
     *
     */
    ...
    /**
     * If there are more data points than hideBulletsCount, the bullets will not
     * be shown. 0 means the bullets will always be visible.
     *
     */
    ...
    /**
     * Name of the high field (used by candlesticks and ohlc) in your
     * dataProvider.
     *
     */
    ...
    /**
     * Unique id of a graph. It is not required to set one, unless you want to
     * use this graph for as your scrollbar's graph and need to indicate which
    ...
    /**
     * Whether to include this graph when calculating min and max value of the
     * axis.
     *
     */
    ...
    /**
     * Position of value label. Possible values are: "bottom", "top", "right",
     * "left", "inside", "middle". Sometimes position is changed by the chart,
     * depending on a graph type, rotation, etc.
     *
     */
    ...
    /**
     * Value label text. You can use tags like [[value]], [[description]],
     * [[percents]], [[open]], [[category]].
     *
     */
    ...
    /**
     * Legend marker opacity. Will use lineAlpha if not set. Value range is 0 -
     * 1.
     *
     */
    ...
    /**
     * The text which will be displayed in the value portion of the legend when
     * user is not hovering above any data point. The tags should be made out of
     * two parts - the name of a field (value / open / close / high / low) and
     * the value of the period you want to be show - open / close / high / low /
     * sum / average / count. For example: [[value.sum]] means that sum of all
     * data points of value field in the selected period will be displayed.
     *
     */
    ...
    /**
     * Legend value text. You can use tags like [[value]], [[description]],
     * [[percents]], [[open]], [[category]] You can also use custom fields from
     * your dataProvider. If not set, uses Legend's valueText.
     *
     */
...
//    }
     ...
     * possibility to change graphs’ line color on any data point to create
     * highlighted sections of the graph.
     *
     */
    ...
    /**
     * Name of the low field (used by candlesticks and ohlc) in your
     * dataProvider.
     *
     */
    ...
    /**
     * Legend marker type. You can set legend marker (key) type for individual
     * graphs. Possible values are: square, circle, diamond, triangleUp,
    ...
    /**
     * It is useful if you have really lots of data points. Based on this
     * property the graph will omit some of the lines (if the distance between
     * points is less that minDistance, in pixels). This will not affect the
     * bullets or indicator in anyway, so the user will not see any difference
     * (unless you set minValue to a bigger value, let say 5), but will increase
     * performance as less lines will be drawn. By setting value to a bigger
     * number you can also make your lines look less jagged.
     *
     */
    ...
    /**
     * If you use different colors for your negative values, a graph below zero
     * line is filled with negativeColor. With this property you can define a
     * different base value at which colors should be changed to negative
     * colors.
     *
     */
    ...
    /**
     * Fill opacity of negative part of the graph. Will use fillAlphas if not
     * set.
     *
     */
    ...
    /**
     * Opacity of the negative portion of the line (or column border). Value
     * range is 0 - 1.
     *
     */
    ...
    /**
     * Color of the line (or column) when the values are negative. In case the
     * graph type is candlestick or ohlc, negativeLineColor is used when close
    ...
    /**
     * If you set it to true, column chart will begin new stack. This allows
     * having Clustered and Stacked column/bar chart.
     *
     */
    ...
    /**
     * In case you want to have a step line graph without risers, you should set
     * this to true.
     *
     */
    ...
    /**
     * Name of the open field (used by floating columns, candlesticks and ohlc)
     ...
     * optionally it might have x, y, randomX and randomY values. For example:
     * {"url":"../amcharts/patterns/black/pattern1.png", "width":4, "height":4}.
     * If you want to have individual patterns for each column, define patterns
     * in data provider and set graph.patternField property. Check
     * amcharts/patterns folder for some patterns. You can create your own
     * patterns and use them. Note, x, y, randomX and randomY properties won't
     * work with IE8 and older. 3D bar/Pie charts won't work properly with
     * patterns.
     *
     */
    ...
    /**
     * Field name in your data provider which holds pattern information. Value
     * of pattern should be object with url, width, height of an image,
     * optionally it might have x, y, randomX and randomY values. For example:
     * {"url":"../amcharts/patterns/black/pattern1.png", "width":4, "height":4}.
     * Check amcharts/patterns folder for some patterns. You can create your own
     * patterns and use them. Note, x, y, randomX and randomY properties won't
     * work with IE8 and older. 3D bar/Pie charts won't work properly with
     * patterns.
     *
    ...
    /**
     * This property can be used by step graphs - you can set how many periods
    ...
    /**
     * Specifies where data points should be placed - on the beginning of the
     * period (day, hour, etc) or in the middle (only when parseDates property
     * of categoryAxis is set to true). This setting affects Serial chart only.
    ...
    /**
     * If graph's type is column and labelText is set, graph hides labels which
     * do not fit into the column's space. If you don't want these labels to be
     * hidden, set this to true.
     *
     */
    ...
    /**
     * Specifies whether the value balloon of this graph is shown when mouse is
     * over data item or chart's indicator is over some series.
     *
     */
    ...
    /**
     * Specifies graphs value at which cursor is showed. This is only important
     * for candlestick and ohlc charts, also if column chart has "open" value.
    ...
    /**
     * Works with candlestick graph type, you can set it to open, close, high,
     * low. If you set it to high, the events will be shown at the tip of the
     * high line.
     *
     */
    ...
    /**
     * If you want mouse pointer to change to hand when hovering the graph, set
    ...
    /**
     * Type of the graph. Possible values are: "line", "column", "step",
     * "smoothedLine", "candlestick", "ohlc". XY and Radar charts can only
    ...
    /**
     * Specifies which value axis the graph will use. Will use the first value
     * axis if not set. You can use reference to the real ValueAxis object or
     * set value axis id.
     *
     */
